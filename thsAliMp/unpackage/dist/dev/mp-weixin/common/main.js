...
/* 0 */
/*!**********************************************************!*\
  !*** /Users/yss-work/workPlace/前端代码/thsMp/thsMp/main.js ***!
  \**********************************************************/
...
var _filters = _interopRequireDefault(__webpack_require__(/*! ./filters */ 16));
var _index = _interopRequireDefault(__webpack_require__(/*! ./http/index.js */ 13));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
/* 5 */
/*!**********************************************************!*\
  !*** /Users/yss-work/workPlace/前端代码/thsMp/thsMp/App.vue ***!
  \**********************************************************/
/*! no static exports found */
...
/* 6 */
/*!***********************************************************************************!*\
  !*** /Users/yss-work/workPlace/前端代码/thsMp/thsMp/App.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...

{
  ...
  (0, _vuex.mapState)(['oldMarketMap', 'newMarketMap', 'sysInfo', 'loginInfo'])),

  methods: _objectSpread(_objectSpread({},
  _vuex.mapActions['getMarketMap']), {}, {
    getiPhoneX: function getiPhoneX() {var _this = this;
      wx.getSystemInfo({
        success: function success(res) {
          var model = res.model.replace(/\s/g, '').toLocaleLowerCase();
          var sys = res.system.replace(/\s/g, '').toLocaleLowerCase();
          var xList = ['iphonex', 'iphonrx'];

          if (xList.some(function (item) {return model.match(item);})) {
            _this.globalData.isX = true;
            _this.$store.commit('setiPhoneX', true);
          }

          if (sys.match('ios')) {
            _this.globalData.isIOS = true;
          }
          var modelTwo = res.model;
    ...
    formatSysInfo: function formatSysInfo(data) {
      if (wx.getMenuButtonBoundingClientRect) {
        ...
        if (data.statusBarHeight) {
          diff = menu.top - data.statusBarHeight; //获取差距
        }
        var meunLeft = data.windowWidth - menu.left - menu.width / 4;
        var height = data.statusBarHeight + diff * 2 + 32; //计算导航高度 状态栏 间距×2 胶囊按钮高度
        var cheight = diff * 2 + 32; //导航内容高度，去掉状态栏高度
    ...
    getUserLoginInfo: function getUserLoginInfo(data) {var _this2 = this;
      var that = this;
      this.$store.dispatch('getToken', { first: true }).then().catch(function () {
        setTimeout(function () {
          _this2.getUserLoginInfo();
        }, 500);
      });
    },
    getStoreLoginInfo: function getStoreLoginInfo() {
      var userLoginInfo = uni.getStorageSync('loginInfo');
      if (userLoginInfo) {
        //检查session_key是否过期
        var data = JSON.parse(userLoginInfo);
    ...
    checkSession: function checkSession(data) {
      var that = this;
      wx.checkSession({
        success: function success() {
          //session_key 未过期，并且在本生命周期一直有效
          that.$store.commit("setLoginInfo", data);
        },
        fail: function fail() {
          // session_key 已经失效，需要重新执行登录流程
          that.getUserLoginInfo(data);
        } });
...
/* 9 */
/*!*******************************************************************************************!*\
  !*** /Users/yss-work/workPlace/前端代码/thsMp/thsMp/App.vue?vue&type=style&index=0&lang=css& ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
